...
import importlib, classes_and_functions
importlib.reload(classes_and_functions)

from classes_and_functions import CompInSup, random_active_circuits
...
plt.xlabel('Layer')
plt.ylabel('MSE')
plt.title(f'T={T}, D={D}, Dod={Dod}, S={S}\nbs={bs}, n={n}')
plt.show()
# %%
